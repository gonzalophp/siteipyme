...
CREATE INDEX CONCURRENTLY "PRICES_p_status" ON "IPYME_AUX"."PRICES" USING btree (p_status ASC NULLS LAST);
...
CREATE INDEX CONCURRENTLY "BASKET_b_confirmed" ON "IPYME_AUX"."BASKET" USING btree (b_confirmed ASC NULLS LAST);
...
CREATE UNIQUE INDEX CONCURRENTLY "USER_u_session"  ON "IPYME_AUX"."USER" USING btree (u_session ASC NULLS LAST);
...
CREATE UNIQUE INDEX CONCURRENTLY "PRODUCT_CATEGORY_pc_path" ON "IPYME_AUX"."PRODUCT_CATEGORY" USING btree (pc_path ASC NULLS LAST);
